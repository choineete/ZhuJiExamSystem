...
public class WxUtil {
    ...
    public static String getOpenId(String appId,String secret,String code){
        try (CloseableHttpClient httpClient = HttpClientBuilder.create().build()){
            ...
            HttpEntity responseEntry = httpClient.execute(httpGet).getEntity();
            if (responseEntry != null){
                String responseStr = EntityUtils.toString(responseEntry);
    ...
    public static void main(String[] args) {
        String appid = "wx97dd8af79bb5f0f1";
        String secret = "6fc3dbe95cd3044ffc3e4e21920dd228";
        String code = "073Erx100t4GpN1Rns300ob7xj3Erx1u";
